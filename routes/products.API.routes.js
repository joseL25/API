...
productRouter.post('/create-product',authLogged,uploadProd);

// ruta API para editar un producto
productRouter.put('/product-edit/:id',authLogged,updateProd);

// ruta API para eliminar un producto
productRouter.delete('/delete/:id',authLogged,deleteProd)
